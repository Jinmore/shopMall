...
return array(
	...
	/********************* 要生成的模型文件中的代码 ******************************/
	// 添加时允许接收的表单中的字段
	'insertFields' => "array('pri_name','model_name','controller_name','action_name','parent_id')",
	// 修改时允许接收的表单中的字段
	'updateFields' => "array('id','pri_name','model_name','controller_name','action_name','parent_id')",
	'validate' => "
		array('pri_name', 'require', '权限名称不能为空！', 1, 'regex', 3),
		array('pri_name', '1,30', '权限名称的值最长不能超过 30 个字符！', 1, 'length', 3),
		array('model_name', '1,30', '模型名称的值最长不能超过 30 个字符！', 2, 'length', 3),
