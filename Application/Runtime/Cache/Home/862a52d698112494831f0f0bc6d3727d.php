...
<div class="main w1210 mt10 bc">
  ...
  <div class="goods_left fl">
    ...
    <div class="viewd leftbar mt10">
      ...
      <div class="leftbar_wrap" id="displayHistory">
  ...
  <div class="goods_content fl mt10 ml10">
    ...
    <div class="summary">
      ...
      <div class="preview fl">
        <div class="midpic">
          <a href="/Public/Uploads/<?php echo ($info['mbig_img']); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
            <img src="/Public/Uploads/<?php echo ($info['big_img']); ?>" alt="" />               <!-- 第一幅图片的中图 -->
          </a>
        </div>
        ...
        <div class="smallpic">
          ...
          <div class="smallpic_wrap">
            <ul>
              <li class="cur">
                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Public/Uploads/<?php echo ($info['mid_img']); ?>',largeimage: '/Public/Uploads/<?php echo ($info['big_img']); ?>'}"><img src="/Public/Uploads/<?php echo ($info['sm_img']); ?>"></a>
              </li>
              <?php foreach($gpicData as $v) :?>
              <li>
                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Public/Uploads/<?php echo ($v['mid_pic']); ?>',largeimage: '/Public/Uploads/<?php echo ($v['big_pic']); ?>'}"><img src="/Public/Uploads/<?php echo ($v['sm_pic']); ?>"></a>
              </li>
            <?php endforeach;?>
      ...
      <div class="goodsinfo fl ml10">
        <ul>
          ...
          <li class="shop_price"><span>购买价：</span><strong id="ajaxBuy"></strong></li>
          <li class="shop_price"><span>上架时间：</span><?php echo ($info['addtime']); ?></li>
            ...
            <li class="product">
              <dl>
                ...
                <dd>
                  ...
                  <input type="radio" <?php if($k1==0) echo "checked='checked'";?> name="goods_attr_id[<?php echo ($v1['attr_id']); ?>]" value="<?php echo ($v1['id']); ?>"   /></a>
                <?php endforeach;?>
                </dd>
              </dl>
            </li>
    ...
    <div class="detail">
      ...
      <div class="detail_bd">
        ...
        <div class="introduce detail_div none">
          <div class="attr mt15">
            <ul>
              <?php foreach($attr_uni as $k=>$v) :?>
                <?php foreach($v as $v1) :?>
              <li><span><?php echo ($k); ?>：</span><?php echo ($v1['attr_value']); ?></li>
            <?php endforeach;?>
            <?php endforeach;?>
            </ul>
          </div>
          ...
          <div class="comment_form mt20">
            <form id="comment_form" method="post">
              ...
              <ul>
                <li>
                  <label for=""> 评分：</label>
                  <input type="radio" value='5' name="start" checked="checked"/> <strong class="star star5"></strong>
                  <input type="radio" value='4' name="start"/> <strong class="star star4"></strong>
                  <input type="radio" value='3'name="start"/> <strong class="star star3"></strong>
                  <input type="radio" value='2' name="start"/> <strong class="star star2"></strong>
                  <input type="radio" value='1' name="start"/> <strong class="star star1"></strong>
                </li>

                <li>
                  <label for="">评价内容：</label>
                  <textarea  id="" cols="" rows="" name="content"></textarea>
                </li>
                <li>
                  <label for="">&nbsp;</label>
...
var viewPath='<?php echo $config['viewPath']?>';
  $.ajax({
    type:'GET',
    url:"<?php echo U('Index/ajaxGetHistory?id='.$info['id']) ?>",
    dataType:'json',
    success:function(data){
      var html="";
      $(data).each(function (k,v){
        html += '<dl><dt><a href="<?php echo U('goods', '', FALSE); ?>/id/'+v.id+'"><img src="'+viewPath+v.mid_img+' "></a></dt><dd><a href="<?php echo U('goods', '', FALSE); ?>/id/'+v.id+'">'+v.goods_name+'</a></dd></dl>';
  ...
  $.ajax({
    type:'GET',
    url:"<?php echo U('Index/ajaxGetMemberPrice?id='.$info['id'])?>",
    success:function(data){
      $('#ajaxBuy').html(data);
    }
  });
  ...
  $('.comment_btn').click(function(){
    // 先接收表单中的数据，并拼成格式如下的字符串 name=aaa&age=bbbb
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        {
           form.trigger('reset');//清空表单
           var html = '<div class="comment_items mt10 none"><div class="user_pic"><dl><dt><a href=""><img src="'+data.info.face+'" alt="" /></a></dt><dd><a href="">'+data.info.username+'</a></dd></dl></div><div class="item"><div class="title"><span>'+data.info.addtime+'</span><strong class="star star'+data.info.start+'"></strong></div><div class="comment_content">'+data.info.content+'</div><div class="btns"><a href="javascript:void(0);" onclick="do_reply(this,'+data.info.id+');" class="reply">回复(0)</a><a href="" class="useful">有用(0)</a></div><div class="reply_form"></div><ul class="reply_container"></ul></div><div class="cornor"></div></div>';
   				// 把整个评论的字符串转化成jq的对象
           html=$(html);
