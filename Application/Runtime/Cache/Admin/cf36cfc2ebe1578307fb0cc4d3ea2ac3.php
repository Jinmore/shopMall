...
<div class="main-div">
    <form name="main_form" method="POST" action="/shangcheng/index.php/Admin/Role/edit/id/3.html" enctype="multipart/form-data" >
                ...
                <td>
                  <?php foreach ($priData as $k => $v): ?>
                    <?php echo str_repeat('-', 8*$v['level']); ?>
                      <input level_id="<?php echo $v['level']; ?>" <?php if(in_array($v['id'],$_arr)) echo "checked";?> type="checkbox" name="pri_id[]" value="<?php echo $v['id']; ?>" />
