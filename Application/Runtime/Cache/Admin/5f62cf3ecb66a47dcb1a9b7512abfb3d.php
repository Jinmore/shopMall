...
.explode {
  background:url(/shangcheng/Public/Admin/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/shangcheng/Public/Admin/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/shangcheng/Public/Admin/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/shangcheng/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<script type="text/javascript" src="/shangcheng/Public/Admin/Js/global.js"></script>
<script type="text/javascript" src="/shangcheng/Public/Admin/Js/utils.js"></script>
<script type="text/javascript" src="/shangcheng/Public/Admin/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/shangcheng/Public/Admin/Images/menu_minus.gif' : '/shangcheng/Public/Admin/Images/menu_plus.gif';
