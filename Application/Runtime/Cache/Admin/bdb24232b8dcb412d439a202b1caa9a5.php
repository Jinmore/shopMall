...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="/shangcheng/Public/Admin/Images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
        ...
        <div id="send_info">
            您好 , 欢迎<?php echo session('username')?>登陆
...
<div id="menu-div">
    <ul>
        ...
        <li><a href="/shangcheng/index.php/Admin/goods/list" target="main-frame">商品列表</a></li>
