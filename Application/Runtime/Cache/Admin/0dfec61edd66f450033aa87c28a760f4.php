...
<form method="post" action=""onsubmit="return validate()">
    <table cellspacing="0" cellpadding="0" style="margin-top:100px" align="center">
        <tr>
            <td>
                <img src="/shangcheng/Public/Admin/Images/login.png" width="178" height="256" border="0" alt="ECSHOP" />
            </td>
                ...
                <table>
                    ...
                    <tr>
                      <td colspan="2" align="right">
                        <img style="cursor:pointer" src="<?php echo U('chkcode'); ?>" onclick="this.src='<?php echo U('chkcode');?>#'+Math.random();" /></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="right">
                            <img src="" />
