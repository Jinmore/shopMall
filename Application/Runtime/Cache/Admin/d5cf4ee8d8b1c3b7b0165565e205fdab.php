...
<div class="main-div">
    <form name="main_form" method="POST" action="/shangcheng/index.php/Admin/Privilege/edit/id/4.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input  type="text" name="model_name" value="<?php echo $data['model_name']; ?>" />
                </td>
            </tr>
            <tr>
