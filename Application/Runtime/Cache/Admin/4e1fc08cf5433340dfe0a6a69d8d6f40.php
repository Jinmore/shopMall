...
<div class="main-div">
    <form name="main_form" method="POST" action="/shangcheng/index.php/Admin/Brand/edit/id/3.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input  type="text" name="brand_url" value="<?php echo $data['brand_url']; ?>" />
                </td>
            </tr>
            <tr>
