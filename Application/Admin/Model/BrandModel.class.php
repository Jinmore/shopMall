...
class BrandModel extends Model 
{
	...
	protected $updateFields = array('id','brand_name','brand_url');
	protected $_validate = array(
		array('brand_name', '1,30', '品牌名称的值最长不能超过 30 个字符！', 2, 'length', 3),
		array('brand_url', '1,120', '官方网址的值最长不能超过 120 个字符！', 2, 'length', 3),
	);
